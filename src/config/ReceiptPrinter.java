...
public class ReceiptPrinter implements Printable {
    ...
    public ReceiptPrinter(JPanel panelToPrint) {
...
public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
    ...
    double width = 4.25 * 72; // 8.5 inches converted to points (1 inch = 72 points)
    double height = 5.5 * 72; // 11 inches converted to points
